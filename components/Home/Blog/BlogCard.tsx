            ...
            <div className='p-6'>
                <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-2'>
                        ...
                        <span className='text-sm text-gray-700 cursor-auto'>{blog.date}</span>
                    </div>
                    <div className='flex items-center space-x-2'>
                        <BiMessage className='text-rose-500'/>
                        <span className='text-sm text-gray-700 cursor-auto'>{blog.comment}</span>
                    </div>
                </div>
                <h1 className='mt-6 font-bold hover:underline cursor-pointer mb-2 text-md text-gray-700'>
                    {blog.title}
                </h1>
